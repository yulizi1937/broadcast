...
/**
 * <b>Description:</b></br>SyncAlarmReceiver : Alarm Manager wakes up with periodic frequency</br>
...
public class SyncAlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void setAlarm(Context context) {
		 ...
		 * device's clock, and to repeat once a day.
		...
		mAlarmManager.setRepeating(AlarmManager.RTC_WAKEUP,calendar.getTimeInMillis() + (1000 * 60 * 5),
				1000 * 60 * ApplicationLoader.getPreferences().getSyncFrequency(), mPendingIntent);
