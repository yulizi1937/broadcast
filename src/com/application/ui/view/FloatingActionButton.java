...
public class FloatingActionButton extends ImageButton {
    ...
    public void attachToListView(@NonNull AbsListView listView,
                                 FABScrollDirectionListener scrollDirectionListener) {
    ...
    public void attachToScrollView(@NonNull FABObservableScrollView scrollView) {
...
//        recyclerView.addOnScrollListener(scrollDetector);
    ...
    public void attachToScrollView(@NonNull FABObservableScrollView scrollView,
                                   FABScrollDirectionListener scrollDirectionListener,
                                   FABObservableScrollView.OnScrollChangedListener onScrollChangedListener) {
    ...
    private class AbsListViewScrollDetectorImpl extends FABAbsListViewScrollDetector {
        private FABScrollDirectionListener mScrollDirectionListener;
        private AbsListView.OnScrollListener mOnScrollListener;

        private void setScrollDirectionListener(FABScrollDirectionListener scrollDirectionListener) {
    ...
    private class RecyclerViewScrollDetectorImpl extends FABRecyclerViewScrollDetector {
        private FABScrollDirectionListener mScrollDirectionListener;
    ...
    private class ScrollViewScrollDetectorImpl extends FABScrollViewScrollDetector {
        private FABScrollDirectionListener mScrollDirectionListener;

        private FABObservableScrollView.OnScrollChangedListener mOnScrollChangedListener;

        private void setScrollDirectionListener(FABScrollDirectionListener scrollDirectionListener) {
            mScrollDirectionListener = scrollDirectionListener;
        }

        public void setOnScrollChangedListener(FABObservableScrollView.OnScrollChangedListener onScrollChangedListener) {
