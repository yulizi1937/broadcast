...
public class DiscreteSeekBarAlmostRippleDrawable extends DiscreteSeekBarStateDrawable implements Animatable {
    ...
    public DiscreteSeekBarAlmostRippleDrawable(@NonNull ColorStateList tintStateList) {
        super(tintStateList);
