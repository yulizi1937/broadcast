...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static int TAB_VIEW_PADDING_DIPS = 17;
    private static int TAB_VIEW_TEXT_SIZE_SP = 11;
...
//                tabTitleView.setTextColor(Color.WHITE);
            ...
            tabTitleView.setTextColor(getResources().getColorStateList(R.color.selector_tab_text_color));
        }
    }
    ...
    private void setMaterialRippleOnView(View mView){
		try{
	        ...
	        .rippleHover(true)
	        .rippleOverlay(true)
	        .rippleBackground(Color.parseColor(getResources().getString(R.color.toolbar_background)))
	        .create();
		}catch(Exception e){
