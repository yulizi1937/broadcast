...
public class MaterialCab implements Serializable, Toolbar.OnMenuItemClickListener {
    ...
    public MaterialCab reset() {
        mTitle = Utilities.resolveString(mContext, R.attr.mcab_title);
        mPopupTheme = Utilities.resolveResId(mContext, R.attr.mcab_popup_theme,
                R.style.ThemeOverlay_AppCompat_Light);
        mContentInsetStart = Utilities.resolveDimension(mContext, R.attr.mcab_contentinset_start,
                R.dimen.mcab_default_content_inset);
        mMenu = Utilities.resolveResId(mContext, R.attr.mcab_menu, 0);
        mBackgroundColor = Utilities.resolveColor(mContext, R.attr.mcab_background_color,
                Utilities.resolveColor(mContext, R.attr.colorPrimary, Color.GRAY));
        mCloseDrawable = Utilities.resolveResId(mContext, R.attr.mcab_close_drawable,
                Utilities.resolveResId(mContext, R.attr.actionModeCloseDrawable,
    ...
    public MaterialCab setContentInsetStartAttr(@AttrRes int contentInsetAttr) {
        return setContentInsetStart(Utilities.resolveInt(mContext, contentInsetAttr, 0));
    }
    ...
    public MaterialCab setBackgroundColorAttr(@AttrRes int colorAttr) {
        return setBackgroundColor(Utilities.resolveColor(mContext, colorAttr, 0));
    }
