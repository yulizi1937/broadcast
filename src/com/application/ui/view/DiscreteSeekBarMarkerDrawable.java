...
/**
 * Implementation of {@link DiscreteSeekBarStateDrawable} to draw a morphing marker symbol.
 * <p>
 ...
 * @hide
 */
public class DiscreteSeekBarMarkerDrawable extends DiscreteSeekBarStateDrawable implements Animatable {
    ...
    public DiscreteSeekBarMarkerDrawable(@NonNull ColorStateList tintList, int closedSize) {
        super(tintList);
