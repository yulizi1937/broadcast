 ...
 * @see #dismiss()
 * @see #dismissComplete()
 * @see org.adw.library.widgets.discreteseekbar.internal.DiscreteSeekBarPopupIndicator.Floater
 */
public class DiscreteSeekBarPopupIndicator {
    ...
    //... phew!
    private DiscreteSeekBarMarkerDrawable.MarkerAnimationListener mListener;
    private int[] mDrawingLocation = new int[2];
    Point screenSize = new Point();

    public DiscreteSeekBarPopupIndicator(Context context, AttributeSet attrs, int defStyleAttr, String maxValue) {
    ...
    public void setListener(DiscreteSeekBarMarkerDrawable.MarkerAnimationListener listener) {
        mListener = listener;
    }
     ...
     * I wanted to use the {@link DiscreteSeekBarMarker} directly
     ...
     */
    private class Floater extends FrameLayout implements DiscreteSeekBarMarkerDrawable.MarkerAnimationListener {
        private DiscreteSeekBarMarker mMarker;
        private int mOffset;

        public Floater(Context context, AttributeSet attrs, int defStyleAttr, String maxValue) {
            super(context);
            mMarker = new DiscreteSeekBarMarker(context, attrs, defStyleAttr, maxValue);
        ...
        public void setFloatOffset(int x) {
            ...
            if (!DiscreteSeekBarCompat.isHardwareAccelerated(this)) {
                invalidate();
            }
        }
