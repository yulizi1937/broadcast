 ...
 * *****************************************METHODS INFORMATION******************************************************** 
 * ********************************************************************************************************************
 * DEVELOPER		  INDEX                   METHOD								DESCRIPTION
 * ********************************************************************************************************************
 * VIKALP PATEL       TU002
 * VIKALP PATEL       TU003                                                         ADD RECTANGLE ON PAGERSLIDINGTABSTRIPS                          			
 * ********************************************************************************************************************
...
//	private int tabTextColor = 0xFF666666;
	...
	protected void onDraw(Canvas canvas) {
		...
		if (currentPositionOffset > 0f && currentPosition < tabCount - 1) {
		 ...
		 //SA TU003 
		 canvas.drawRect(lineLeft, height - indicatorHeight - 8, lineRight,height- 8,rectPaint); //BOTTOM
		 canvas.drawRect(lineLeft, 8, lineRight, 8+indicatorHeight, rectPaint); //TOP
		 canvas.drawRect(lineLeft, 8, lineLeft + indicatorHeight, height - 8, rectPaint); //LEFT
		 canvas.drawRect(lineRight, 8, lineRight + indicatorHeight, height - 8, rectPaint); //RIGHT
		 //EA TU003
...
//		 canvas.drawRect(lineLeft, height - indicatorHeight, lineRight,height,rectPaint); //BOTTOM
		 //EU TU002
