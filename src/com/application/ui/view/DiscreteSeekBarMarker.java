 ...
 * and the {@link org.adw.library.widgets.discreteseekbar.internal.drawable.DiscreteSeekBarMarkerDrawable}
 * with the required positions and offsets
 * </p>
 *
 * @hide
 */
public class DiscreteSeekBarMarker extends ViewGroup implements DiscreteSeekBarMarkerDrawable.MarkerAnimationListener {
    ...
    DiscreteSeekBarMarkerDrawable mMarkerDrawable;

    public DiscreteSeekBarMarker(Context context) {
        this(context, null);
    }

    public DiscreteSeekBarMarker(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.discreteSeekBarStyle);
    }

    public DiscreteSeekBarMarker(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, "0");
    }

    public DiscreteSeekBarMarker(Context context, AttributeSet attrs, int defStyleAttr, String maxValue) {
        ...
        DiscreteSeekBarCompat.setTextDirection(mNumber, TEXT_DIRECTION_LOCALE);
        ...
        int thumbSize = (int) (DiscreteSeekBarThumbDrawable.DEFAULT_SIZE_DP * displayMetrics.density);
        ColorStateList color = a.getColorStateList(R.styleable.DiscreteSeekBar_dsb_indicatorColor);
        mMarkerDrawable = new DiscreteSeekBarMarkerDrawable(color, thumbSize);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            DiscreteSeekBarCompat.setOutlineProvider(this, mMarkerDrawable);
        }
        a.recycle();
    }
    ...
    public void onOpeningComplete() {
        ...
        if (getParent() instanceof DiscreteSeekBarMarkerDrawable.MarkerAnimationListener) {
            ((DiscreteSeekBarMarkerDrawable.MarkerAnimationListener) getParent()).onOpeningComplete();
        }
    }
    ...
    public void onClosingComplete() {
        if (getParent() instanceof DiscreteSeekBarMarkerDrawable.MarkerAnimationListener) {
            ((DiscreteSeekBarMarkerDrawable.MarkerAnimationListener) getParent()).onClosingComplete();
        }
    }
