 ...
 * @hide
 */
public class DiscreteSeekBarCompat {
     ...
     */
    public static void setOutlineProvider(View view, final DiscreteSeekBarMarkerDrawable markerDrawable) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            DiscreteSeekBarCompatDontCrash.setOutlineProvider(view, markerDrawable);
        }
    }
    ...
    public static Drawable getRipple(ColorStateList colorStateList) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            return DiscreteSeekBarCompatDontCrash.getRipple(colorStateList);
        } else {
            return new DiscreteSeekBarAlmostRippleDrawable(colorStateList);
        }
    }
    ...
    public static void setBackground(View view, Drawable background) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            DiscreteSeekBarCompatDontCrash.setBackground(view, background);
        } else {
    ...
    public static void setTextDirection(TextView textView, int textDirection) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            DiscreteSeekBarCompatDontCrash.setTextDirection(textView, textDirection);
        }
    }

    public static boolean isInScrollingContainer(ViewParent p) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            return DiscreteSeekBarCompatDontCrash.isInScrollingContainer(p);
        }
        return false;
    }
    ...
    public static boolean isHardwareAccelerated(View view) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            return DiscreteSeekBarCompatDontCrash.isHardwareAccelerated(view);
        }
        return false;
    }
}
