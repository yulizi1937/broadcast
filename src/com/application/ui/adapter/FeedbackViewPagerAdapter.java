...
public class FeedbackViewPagerAdapter extends FragmentStatePagerAdapter{
	...
	public Fragment getItem(int position) {
		...
		if(mArrayListFeedbackPagerInfo.get(position).getmFeedbackType().equalsIgnoreCase("selective")){
			return FeedbackSelectiveRadioFragment.newInstance(position, mArrayListFeedbackPagerInfo.get(position));	
		}else if(mArrayListFeedbackPagerInfo.get(position).getmFeedbackType().equalsIgnoreCase("multiple")){
			return FeedbackMultipleCheckFragment.newInstance(position, mArrayListFeedbackPagerInfo.get(position));
		}else if(mArrayListFeedbackPagerInfo.get(position).getmFeedbackType().equalsIgnoreCase("rating")){
			return FeedbackRatingFragment.newInstance(position, mArrayListFeedbackPagerInfo.get(position));
		}else{
			return FeedbackSubjectiveFragment.newInstance(position, mArrayListFeedbackPagerInfo.get(position));
		}
	}
