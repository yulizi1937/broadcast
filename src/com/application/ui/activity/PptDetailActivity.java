...
//				mContentFilePath = Utilities.fbConcealDecryptFile(TAG, new File(mContentFilePath));
	...
	private void catchErrorOnFileCorrupted(){
		try{
			AlertDialog.Builder mAlertDialog = new AlertDialog.Builder(PptDetailActivity.this);
				...
				try{
					if(!mContentIsLike){
						...
						if(isContentLiked){
							...
							mPptLikeTv.setCompoundDrawablesWithIntrinsicBounds(R.drawable.bitmap_item_like, 0, 0, 0);
							mPptLikeTv.setText(mContentLikeCount);
							mPptLikeTv.setTextColor(getResources().getColor(R.color.item_activity_color));
