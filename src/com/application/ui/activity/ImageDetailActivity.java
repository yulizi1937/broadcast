				...
				try{
					if(!mContentIsLike){
						...
						if(isContentLiked){
							...
							mImageLikeTv.setCompoundDrawablesWithIntrinsicBounds(R.drawable.bitmap_item_like, 0, 0, 0);
							mImageLikeTv.setText(mContentLikeCount);
							mImageLikeTv.setTextColor(getResources().getColor(R.color.item_activity_color));
