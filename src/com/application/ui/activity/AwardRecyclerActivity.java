...
public class AwardRecyclerActivity extends SwipeBackBaseActivity {
	...
	private static final String TAG = AwardRecyclerActivity.class.getSimpleName();
	...
	private void initToolBar() {
		...
		mToolBar.setTitle(getResources().getString(R.string.AwardRecyclerActivityTitle));
		mToolBar.setNavigationIcon(R.drawable.ic_back_shadow);
		setSupportActionBar(mToolBar);
	}
	
	private void setRecycleAdapter(){
		LinearLayoutManager layoutManager = new LinearLayoutManager(AwardRecyclerActivity.this);
	    mRecyclerView.setLayoutManager(layoutManager);
	    ArrayList<Award> mList= new ArrayList<Award>();
		for (int i = 0; i < 30; i++) {
	    	Award obj = new Award();
	    	obj.setmAwardName("AWARD FOR BEST SALES OF THE WEEK "+String.valueOf(i));
	    	mList.add(obj);
	    }
		...
		mAdapter.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(View view, int position) {
				...
				case R.id.itemRecyclerCongratulateIv:
					Utilities.showCrouton(AwardRecyclerActivity.this, mCroutonViewGroup, "itemRecyclerCongratulateIv", Style.INFO);
					break;
				default:
					Utilities.showCrouton(AwardRecyclerActivity.this, mCroutonViewGroup, "itemRecylerAwardRootLayout", Style.INFO);
					break;
				}
			}
		});
