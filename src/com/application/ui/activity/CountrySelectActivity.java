...
public class CountrySelectActivity extends AppCompatActivity {
	...
	private void initToolBar(){
    	...
    	mToolBarTitleTv.setText(getResources().getString(R.string.CountrySelectActivityTitle));
	}
	...
	@TargetApi(Build.VERSION_CODES.HONEYCOMB) private void setTextWatcher(){
	...
	private void checkToolBarSearchAccordingly(){
		if(!searching){//expand
            ...
            emptyTextView.setText(getResources().getString(R.string.CountrySelectActivityTitle));
		}
	}
	
	@SuppressLint("NewApi") private void initListView(){
        searching = false;
        searchWas = false;

        listViewAdapter = new CountryAdapter(CountrySelectActivity.this);
        searchListViewAdapter = new CountrySearchAdapter(CountrySelectActivity.this, listViewAdapter.getCountries());

        LinearLayout emptyTextLayout = new LinearLayout(CountrySelectActivity.this);
        ...
        listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView absListView, int i) {
                if (i == SCROLL_STATE_TOUCH_SCROLL && searching && searchWas) {
                    AndroidUtilities.hideKeyboard(CountrySelectActivity.this.getCurrentFocus());
                }
            }
