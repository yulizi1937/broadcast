...
public class VideoDetailActivity extends SwipeBackBaseActivity {
	...
	private AppCompatTextView mImageLanguageHeaderTv;
	...
	private void initUi() {
		...
		mImageLanguageHeaderTv = (AppCompatTextView)findViewById(R.id.fragmentImageDetailLanguageHeaderTv);
	  ...
	  {
		  mVideoView.setVideoPath("android.resource://"+  getPackageName() + "/raw/hdfcconverted");
	                ...
	                MediaPlayer.OnPreparedListener()  {
	                     ...
	                     public void onPrepared(MediaPlayer mp) {
	                    	 ...
	                    	 mVideoMediaControllerTotalDurationTv.setText(Utilities.getTimeFromMilliSeconds((long)mTotalDuration));
	                       	 mVideoMediaControllerDiscreteSeekBar.setNumericTransformer(new DiscreteSeekBar.NumericTransformer() {
	                             @Override
	  ...
	  private void initAnimation(){
		  mAnimFadeIn = AnimationUtils.loadAnimation(VideoDetailActivity.this, android.R.anim.fade_in);
		  mAnimFadeOut = AnimationUtils.loadAnimation(VideoDetailActivity.this, android.R.anim.fade_out);
	...
	private void setMediaControllerLayout(){
		if(mVideoView.isPlaying()){
			...
			AndroidUtilities.runOnUIThread(new Runnable() {
				...
				public void run() {
					// TODO Auto-generated method stub
					mVideoMediaControllerFrameLayout.startAnimation(mAnimFadeOut);
				}
			}, 3000);
		}
	}
	...
	private void setSeekBarListener(){
		mVideoMediaControllerDiscreteSeekBar.setOnProgressChangeListener(new OnProgressChangeListener() {
			@Override
