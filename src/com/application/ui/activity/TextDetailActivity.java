				...
				try{
					if(!mContentIsLike){
						...
						if(isContentLiked){
							...
							mTextLikeTv.setCompoundDrawablesWithIntrinsicBounds(R.drawable.bitmap_item_like, 0, 0, 0);
							mTextLikeTv.setText(mContentLikeCount);
							mTextLikeTv.setTextColor(getResources().getColor(R.color.item_activity_color));
