...
public class MotherPagerAdapter extends CacheFragmentStatePagerAdapter {
	...
	public MotherPagerAdapter(FragmentManager fm,ArrayList<MotherHeader> mArrayListMotherHeader) {
		super(fm);
...
//	}
	...
	public SpannableStringBuilder getSpannableStringWithCounter(int position){
		...
		if(mArrayListMotherHeader.get(position).getmUnreadCount().equalsIgnoreCase("0")){
			return stringBuilder.append(mHeaderText);
		}else{
			String mCounterText = mArrayListMotherHeader.get(position).getmUnreadCount()+" ";
