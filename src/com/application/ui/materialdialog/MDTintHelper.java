...
public class MDTintHelper {
    ...
    @SuppressLint("NewApi") public static void setTint(RadioButton radioButton, int color) {
    ...
    @SuppressLint("NewApi") public static void setTint(SeekBar seekBar, int color) {
    ...
    @SuppressLint("NewApi") public static void setTint(ProgressBar progressBar, int color) {
    ...
    @SuppressLint("NewApi") public static void setTint(EditText editText, int color) {
    ...
    @SuppressLint("NewApi") public static void setTint(CheckBox box, int color) {
        ColorStateList sl = new ColorStateList(new int[][]{
                new int[]{-android.R.attr.state_checked},
                new int[]{android.R.attr.state_checked}
        }, new int[]{
