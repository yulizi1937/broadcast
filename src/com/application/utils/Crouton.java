...
public final class Crouton {
  ...
  private FrameLayout initializeCroutonViewGroup(Resources resources) {
    ...
    FrameLayout.LayoutParams  params = new FrameLayout.LayoutParams(width != 0 ? width : FrameLayout.LayoutParams.MATCH_PARENT, height);
//    params.topMargin = AndroidUtilities.dpFromPx(ApplicationLoader.getApplication().getResources().getDimension(R.dimen.toolbar_height));
