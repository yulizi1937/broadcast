...
public class RestClient {
	...
	@SuppressWarnings("deprecation")
	public static String postJSON(String url, JSONObject dataToSend, String TAG)
		...
		try {
			...
			if (response != null) {
				...
				text = JSONRequestBuilder.getErrorMessageFromStatusCode(response.getStatusLine().toString(), response.getStatusLine().getReasonPhrase()).toString();
			}
	...
	@SuppressWarnings("deprecation")
	public static String postString(String url, String dataToSend, String TAG)
			throws JSONException {
		// Create a new HttpClient and Post Header
	...
	@SuppressWarnings("deprecation")
	public static String putJSON(String url, JSONObject dataToSend, String TAG)
			throws JSONException {
		// Create a new HttpClient and Post Header
	...
	@SuppressWarnings("deprecation")
	public static String getJSON(String url, String TAG) throws JSONException {
		// Create a new HttpClient and Post Header
