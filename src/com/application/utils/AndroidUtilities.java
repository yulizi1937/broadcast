...
@SuppressLint("NewApi") public class AndroidUtilities {
    ...
    public static int dpFromPx(final float px) {
        return (int)Math.ceil(px / ApplicationLoader.getApplication().getResources().getDisplayMetrics().density);
    }

    public static int pxFromDp(final int dp) {
        return (int)Math.ceil(dp * ApplicationLoader.getApplication().getResources().getDisplayMetrics().density);
    }
    ...
    @SuppressLint("NewApi") public static Point getRealScreenSize() {
