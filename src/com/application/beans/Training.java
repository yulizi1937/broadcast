...
public class Training implements Parcelable {
	...
	private ArrayList<TrainingFileInfo> mFileInfo;
	...
	public Training(String mId, String mTitle, String mDescription,
			...
			ArrayList<TrainingFileInfo> mFileInfo) {
		super();
		this.mId = mId;
		this.mTitle = mTitle;
	...
	public ArrayList<TrainingFileInfo> getmFileInfo() {
		return mFileInfo;
	}

	public void setmFileInfo(ArrayList<TrainingFileInfo> mFileInfo) {
		this.mFileInfo = mFileInfo;
	}
	...
	protected Training(Parcel in) {
		...
		mLink = in.readString();
		if (in.readByte() == 0x01) {
			mFileInfo = new ArrayList<TrainingFileInfo>();
			in.readList(mFileInfo, TrainingFileInfo.class.getClassLoader());
		} else {
			mFileInfo = null;
		}
	}
